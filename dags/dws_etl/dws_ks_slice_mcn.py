...
@dag(schedule=[Dataset('mysql://cd-cynosdbmysql-grp-lya2inq0.sql.tencentcdb.com:21775/dim/dim_ks_account_info'),
               Dataset('mysql://cd-cynosdbmysql-grp-lya2inq0.sql.tencentcdb.com:21775/dwd/dwd_ks_cps_order'),
...
def dws_ks_slice_mcn():
    ...
    dws_ks_slice_mcn = SQLExecuteQueryOperator(
        task_id='dws_ks_slice_mcn',
        conn_id='mysql',
        sql='sql/dws_ks_slice_mcn.sql',
