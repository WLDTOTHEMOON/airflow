...
def ods_item_category():
    @task(outlets=[Dataset('mysql://ods.ods_item_category')])
...
def ods_special_allocation():
    @task(outlets=[Dataset('mysql://ods.ods_special_allocation')])
...
def ods_cps_order_fake():
    @task(outlets=[Dataset('mysql://ods.ods_cps_order_fake')])
